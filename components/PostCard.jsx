    ...
    <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="inline-block px-8 py-2 font-medium text-white transition duration-500 transform bg-pink-600 rounded-full cursor-pointer hover:-transition-y-1">
            Continue Reading
          </span>
        </Link>
      </div>
